...
                    print(f"Database user '{db_user}' does not exist in the database. Please enter a valid database user.")
                else:
...
            )
            cur = conn.cursor()
            # Updated query to use pg_catalog.pg_namespace
...
                break
            else:
                print(f"Schema '{schema_name}' does not exist. Please enter an existing schema name.")
        except Exception as e:
